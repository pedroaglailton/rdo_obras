  ...
  async init() {
    if (isPostgres) {
      ...
      const stmts = [
        ...
        `CREATE TABLE IF NOT EXISTS etapas (id SERIAL PRIMARY KEY, obra_id INTEGER NOT NULL REFERENCES obras(id) ON DELETE CASCADE, nome TEXT NOT NULL, ordem INTEGER DEFAULT 1, status TEXT DEFAULT 'pendente', data_inicio TEXT, data_fim TEXT, observacoes TEXT, criado_em TIMESTAMPTZ DEFAULT NOW())`,
